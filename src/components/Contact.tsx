    ...
    <section id="contact" className="pt-12 pb-24 bg-muted text-foreground">
      <div className="container mx-auto px-4 md:px-8 lg:px-16">
        ...
        <div className="grid grid-cols-1 gap-12 max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-start gap-4 p-6 bg-background rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 animate-fade-in border-2 border-transparent hover:border-secondary btn-stroke">
                ...
                <div className="flex items-start gap-4 p-6 bg-background rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 animate-fade-in border-2 border-transparent hover:border-secondary btn-stroke" style={{ animationDelay: "0.1s" }}>
                ...
                <div className="flex items-start gap-4 p-6 bg-background rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 animate-fade-in border-2 border-transparent hover:border-secondary btn-stroke" style={{ animationDelay: "0.2s" }}>
                ...
                <div className="flex items-start gap-4 p-6 bg-background rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 animate-fade-in border-2 border-transparent hover:border-secondary btn-stroke" style={{ animationDelay: "0.3s" }}>
          ...
          {/* Contact Form */}
          <div className="bg-card text-card-foreground p-8 rounded-lg shadow-2xl btn-stroke">
